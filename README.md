...
| 3 | [DSpark 投机解码](src/content/lessons/zh/dspark-speculative-decoding.mdx) | 整块起草整块批改的赛跑、按置信度裁剪验证窗口、ragged 打包省 padding | [cookbook](https://sgl-project-sglang-93.mintlify.app/advanced/speculative-decoding) |
