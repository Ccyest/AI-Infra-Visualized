...
export const UPDATE = {
  ...
  sharedStorage: { en: "Shared storage", zh: "共享存储" },
  freeSlot: { en: "Empty", zh: "空闲" },
  retained: { en: "Retained copy P", zh: "保留副本 P" },
  staging: { en: "Staging P", zh: "中转 P" },
  produced: { en: "A: KV ready", zh: "A：KV 就绪" },
  backup: { en: "A: GPU → Host", zh: "A：GPU → Host" },
  stored: { en: "A: L3 backup complete", zh: "A：L3 备份完成" },
  fetched: { en: "B: L3 → Host", zh: "B：L3 → Host" },
  loaded: { en: "B: GPU restore complete", zh: "B：GPU 恢复完成" },
