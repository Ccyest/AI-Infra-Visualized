...
export default function ResultsViz({ lang = "zh" }: { lang?: Locale }) {
  ...
  return <figure className="viz-stage hc-viz">
    <div className="viz-head"><span className="viz-title">{TEXT.benchTitle[lang]}</span><span className="viz-subtitle">{TEXT.benchNote[lang]}</span></div>
    ...
    <div className="viz-footer">{TEXT.warmNote[lang]}</div>
  </figure>;
}
