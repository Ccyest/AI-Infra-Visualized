...
export const S = {
  ...
  threeHoles: { en: "After release: 3 scattered holes", zh: "释放后：3 个分散的空洞" },
  oneHole: { en: "After release: 1 contiguous free range", zh: "释放后：1 段连续的空闲空间" },
  freedCount: { en: "Regions freed", zh: "已空出区域" },
  layoutPause: { en: "Pause", zh: "暂停" },
  layoutReplay: { en: "Replay", zh: "重播" },
  layoutNext: { en: "Next piece", zh: "下一块" },
  layoutReset: { en: "Reset", zh: "回到起点" },
